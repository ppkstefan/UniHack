      ...
      const dictionary = {
        ...
        paper:
          "Material manufactured in thin sheets from the pulp of wood or other fibrous substances, used for writing, drawing, or printing on.",
        bed: "A piece of furniture for sleep or rest, typically a framework with a mattress and coverings.",
        window:
          "An opening in the wall or roof of a building or vehicle, typically with glass in it, to admit light or air and allow people to see out.",
        ...
        tiger:
          "A large solitary cat with a yellow-brown coat striped with black, native to the forests of Asia.",
        bear: "A large, heavy mammal with thick fur and a short tail that is native to North America and Eurasia.",
        horse:
          "A large domesticated mammal with solid hooves, a flowing mane and tail, used for riding, racing, and as a beast of burden.",
        rabbit:
        ...
        turtle:
          "A slow-moving reptile with a shell into which it can retract its head and thick skin.",
        dolphin:
          "A small gregarious toothed whale that typically has a beaklike snout and a curved fin on the back.",
        penguin:
          "A flightless bird that lives in the Southern Hemisphere, especially in Antarctica.",
        giraffe:
        ...
        kangaroo:
          "A large herbivorous marsupial with a long powerful tail and strongly developed hind limbs that enable it to travel by leaping.",
        zebra:
          "A wild animal native to Africa, closely related to the horse, with black and white stripes on its body.",
        ...
        sheep:
          "A domesticated ruminant mammal with a thick woolly coat and typically curly horns.",
        pig: "A domesticated hoofed mammal with sparse bristly hair and a flat snout for rooting in the soil, kept for its meat.",
        chicken:
        ...
        octopus:
          "A sea creature with a soft, oval body and eight sucker-bearing.",
        ...
        hand: [
          "The end part of a persons arm beyond the wrist, including the palm, fingers, and thumb.",
        ],
        part: [
        ...
        school: [
          "A place or institution for teaching and learning; establishment for education, an institution for teaching children",
        ],
        book: [
        ...
        future: [
          "A period of time following the moment of speaking or writing.",
        ],
        spider: [
          "An eight-legged predatory arachnid with an unsegmented body consisting of a fused head and thorax and a rounded abdomen.",
        ],
